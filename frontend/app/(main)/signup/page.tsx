  ...
  return (
    <Box sx={{
      ...
      >
        ...
        <Divider sx={{ mb: 2.5, color: '#9aa0a6', fontSize: '0.75rem' }}>or sign up with email</Divider>

        {/* Form */}
        <Box component="form" onSubmit={handleSubmit} noValidate>
          <TextField margin="normal" required fullWidth id="email" label="Email Address" name="email"
            autoComplete="email" autoFocus value={email} onChange={(e) => setEmail(e.target.value)} size="small"
          ...
          <Typography variant="body2" sx={{ color: '#5f6368', textAlign: 'center' }}>
            ...
            <Link href="/login" style={{ color: '#1a73e8', textDecoration: 'none', fontWeight: 600 }}>Sign In</Link>
          </Typography>
        </Box>
      </Paper>
    </Box>
